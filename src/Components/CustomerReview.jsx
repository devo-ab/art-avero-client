const CustomerReview = () => {
  return (
    <div className="flex flex-col md:flex-row items-center gap-20 mt-10 justify-center">
      <div className="flex flex-col max-w-xl p-8 shadow-sm rounded-xl lg:p-12 border border-indigo-500 text-base-content">
        <div className="flex flex-col w-full">
          <h2 className="text-3xl font-semibold text-center">Overall Reviews</h2>
          <div className="flex flex-wrap items-center mt-2 mb-1 space-x-2">
            ...
            <span className="text-base-content">4 out of 5</span>
          </div>
      ...
      <div className="flex flex-col max-w-xl p-8 shadow-sm rounded-xl lg:p-12 text-base-content border border-indigo-500">
