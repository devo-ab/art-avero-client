...
const SignIn = () => {
    ...
    const { signInWithEmailPass, signInWithGoogle, signInWithTwitter, signInWithGithub } = useContext(AuthContext);
  ...
  const navigate = useNavigate();
    ...
    useEffect(() => {
        document.title = 'Art Avero | Sign In';
      } ,[]);
  ...
  return (
    <div className="w-full mx-auto max-w-md p-8 space-y-3 rounded-xl text-base-content border border-indigo-500 mt-10 mb-10">
      ...
      <form onSubmit={handleSignIn} className="space-y-6">
        ...
        <button className="block btn w-full p-3 text-center rounded-md dark:text-gray-50 bg-indigo-500">
          Sign in
        </button>
      </form>
      ...
      <div className="flex justify-center space-x-4">
        <button onClick={handleGoogleSignIn} aria-label="Log in with Google" className="p-3 btn btn-ghost rounded-full">
          <svg
        ...
        <button onClick={handleTwitterSignIn} aria-label="Log in with Twitter" className="p-3 btn btn-ghost rounded-full">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 32 32"
            className="w-5 h-5 fill-current"
        ...
        <button onClick={handleGithubSignIn} aria-label="Log in with GitHub" className="p-3 btn btn-ghost rounded-full">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 32 32"
            className="w-5 h-5 fill-current"
